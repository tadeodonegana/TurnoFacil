...
public class MainPaciente {
	...
	private static AppPaciente crearApp() {
		...
		s1.addMedico(m3);
		//Turnos
		s1.addTurno(m1, new Turno(LocalDateTime.of(LocalDate.of(2022, 8, 15), LocalTime.of(15, 0)), m1, 100));
		s1.addTurno(m1, new Turno(LocalDateTime.of(LocalDate.of(2022, 8, 15), LocalTime.of(15, 30)), m1, 100));
		s1.addTurno(m3, new Turno(LocalDateTime.of(LocalDate.of(2022, 8, 15), LocalTime.of(20, 30)), m3, 100));
		s1.addTurno(m3, new Turno(LocalDateTime.of(LocalDate.of(2022, 8, 15), LocalTime.of(21, 0)), m3, 100));
		s2.addTurno(m2, new Turno(LocalDateTime.of(LocalDate.of(2022, 8, 15), LocalTime.of(10, 0)), m2, 100));
		s2.addTurno(m2, new Turno(LocalDateTime.of(LocalDate.of(2022, 8, 15), LocalTime.of(11, 0)), m2, 100));
		//Jornadas
		m1.addJornada(new JornadaDiaria("Miercoles", LocalTime.of(15, 0), LocalTime.of(20, 0)));
		m2.addJornada(new JornadaDiaria("Martes", LocalTime.of(10, 0), LocalTime.of(12, 0)));
		m3.addJornada(new JornadaDiaria("Viernes", LocalTime.of(19, 0), LocalTime.of(22, 0)));
		//Obras Sociales
